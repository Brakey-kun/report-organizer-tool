            ...
            <div className="p-6">
              ...
              {files.length > 0 && (
                 <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col gap-3">
                    <label className="flex items-center gap-3 cursor-pointer text-sm text-gray-700 bg-gray-50 p-3 rounded-xl border border-gray-200 hover:bg-gray-100 transition-colors w-full">
                      <input 
                        type="checkbox" 
                      ...
                      <div className="flex flex-col">
                        <span className="font-semibold text-gray-900">Strip Hyperlinks & Annotations</span>
                        <span className="text-xs text-gray-500">Security: Removes all clickable links from the final exported PDF report.</span>
                      </div>
                    </label>
